        ...
        <div class="container-xl">
            <div class="row g-2 align-items-center">
                ...
                <div class="col-12 col-md-auto ms-auto d-print-none">
                    <div class="btn-list">
                        <a href="{{ route('providers.create') }}" class="btn btn-primary d-none d-sm-inline-block">
              ...
              <div class="col-xl-12 text-right">
                  <a href="{{ route('provider.pdf') }}" class="btn btn-success btn-sm">Export to PDF</a>
              </div>
          </div>
                    </div>
                </div>
                ...
                <div class="col-12">
                    <div class="card">
                       ...
                       <div class="card-footer d-flex align-items-center">
                            {!! $providers->links('tablar::pagination') !!}
                        </div>
                    </div>
                </div>
            </div>
