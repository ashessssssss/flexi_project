...
<body>
    ...
    <main class="main-content">
        ...
        <section class="container top-products">
            ...
            <div class="container-products">
                ...
                <div class="card-product">
                    <div class="container-img">
                        <img src="img/senfineco 1.jpg" alt="Cafe incafe-ingles.jpg" />
                ...
                <div class="card-product">
                    <div class="container-img">
                        <img src="img/senfineco 2.jpg" alt="Cafe Australiano" />
                        <div class="button-group">
                            <span><i class="fa-regular fa-eye"></i></span>
                            <span><i class="fa-regular fa-heart"></i></span>
                            <span><i class="fa-solid fa-code-compare"></i></span>
        ...
        <section class="gallery">
            <img src="img/Mapa1.JPG" alt="Gallery Img1" class="gallery-img-1"/>
            <img src="img/mapa2.JPG" alt="Gallery Img2" class="gallery-img-2"/>
            <img src="img/mapa3.JPG" alt="Gallery Img3" class="gallery-img-3"/>
            <img src="img/mapa4.JPG" alt="Gallery Img4" class="gallery-img-4"/>
            <img src="img/mapa5.JPG" alt="Gallery Img5" class="gallery-img-5"/>
        </section>
        <section class="container specials">
            ...
            <div class="container-products">
                ...
                <div class="card-product">
                    <div class="container-img">
                        <img src="img/lavado.jpg" alt="Cafe incafe-ingles.jpg" />
                        <span class="discount">-22%</span>
                        <div class="button-group">
                            <span><i class="fa-regular fa-eye"></i></span>
                            <span><i class="fa-regular fa-heart"></i></span>
            ...
            <div class="container-blogs">
                <div class="card-blog">
                    ...
                    <div class="content-blog">
                        ...
                        <p>Excelente servicio, Mi auto funciona de manera excelente luego de hacerle el cambio de filtro en el establecimiento.</p>
                ...
                <div class="card-blog">
                    ...
                    <div class="content-blog">
                        ...
                        <p>Me encanto todo, la atencion y demas. El servicio es excelente.</p>
                        <div class="btn-read-more">Leer más</div>
                    </div>
                </div>
                <div class="card-blog">
                    ...
                    <div class="content-blog">
                        <h3>Usuario Desconocido</h3>
                        <span>29 Noviembre 2022</span>
                        <p>Estoy muy satisfecho, Mi auto luce y huele genial luego de hacerle una Limpieza interior.</p>
                        <div class="btn-read-more">Leer más</div>
                    </div>
                </div>
            </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const menuToggle = document.querySelector('.navbar .fa-bars');
